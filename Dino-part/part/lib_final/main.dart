...
class _DinoGameScreenState extends State<DinoGameScreen> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    dino = Dino(pos: Offset(80, 100), size: 50, movementd: VerticalMovement(), flyMovement: FlyMovement());
    gctl = Gamecontroller(
      dino: dino,
      obstacles: obstacles,
      items: items,
      gameSpeed: 200,
      evolutionScore: 100,
      evolutionEndScore: 800,
      groundHeight: 100,
      dinoController: AnimationController(duration: Duration(milliseconds: 400), vsync: this),
      planeController: AnimationController(duration: Duration(milliseconds: 3000), vsync: this),
      gameController: AnimationController(duration: Duration(milliseconds: 15), vsync: this)..repeat(),
    );
      ...
      if (!gctl.isPhase1) {
        ...
        if (status == AnimationStatus.completed) {
          Timer(Duration(milliseconds: 50), () {
            gctl.dinoAnimation = dino.movement.move(e: dino, gameSpeed: gctl.gameSpeed, gctl: gctl);
            gctl.dinoController.reset();

            gctl.planeAnimation = dino.flyMovement.move(e: dino, gameSpeed: gctl.gameSpeed, gctl: gctl);
  ...
  void dispose() {
    ...
    gctl.soundBundle.stopAll();
    gctl.soundBundle.disposeAll();
        ...
        child: SizedBox(
          ...
          child: Stack(
            children: [
                ...
                child: Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [Color.fromARGB(255, 183, 255, 254), Colors.white],
                    ),
                  ),
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      gctl.isPhase1
                          ? 'Fuel: ${dino.health.toInt().toString().padLeft(3, '0')}'
                          : 'Health: ${dino.health.toInt().toString().padLeft(3, '0')}',
                      style: GoogleFonts.pressStart2p(
                        fontSize: 16,
                        ...
                        children: [
                          if (!gctl.isGameStarted) ...[
                            ...
                            Text(
                              ...
                              style: GoogleFonts.pressStart2p(fontSize: 16, color: Colors.grey[600]),
                            ),
                          ] else ...[
                            Text(
                              'GAME OVER',
                            ...
                            ElevatedButton(
                              ...
                              child: Text('RESTART', style: GoogleFonts.pressStart2p(fontWeight: FontWeight.w400)),
                            ),
                          ],
                        ],
                      ),
              ...
              if (gctl.isGameStarted && !gctl.isGameOver && gctl.isHitTheCactus)
                Positioned.fill(
                  child: Container(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          Color.fromARGB(255, 255, 3, 3).withValues(alpha: 1),
                          Color.fromARGB(255, 255, 3, 3).withValues(alpha: 0),
                          Color.fromARGB(255, 255, 3, 3).withValues(alpha: 0),
                          Color.fromARGB(255, 255, 3, 3).withValues(alpha: 1),
                        ],
                      ),
              ...
              if (gctl.isGameStarted && !gctl.isGameOver && gctl.isHitTheHeal)
                Positioned.fill(
                  child: Container(
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          Color.fromARGB(255, 3, 255, 20).withValues(alpha: 0.8),
                          Color.fromARGB(255, 3, 255, 20).withValues(alpha: 0),
                          Color.fromARGB(255, 3, 255, 20).withValues(alpha: 0),
                          Color.fromARGB(255, 3, 255, 20).withValues(alpha: 0.8),
                        ],
                      ),
